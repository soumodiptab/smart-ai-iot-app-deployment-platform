...
def addToCron(data, config_file):
    ...
    job = my_cron.new(command='python3 ' + start_script + " " + app_id + " " + app_instance_id + " " + is_model+ " " + periodicity + " " + periodicity_unit + " " + app_cron_dir)
    ...
    job2 = my_cron.new(command='python3 ' + stop_script + " " + app_id + " " + app_instance_id + " " + config_file + " " + app_cron_dir)
